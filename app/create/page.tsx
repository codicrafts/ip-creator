  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50 pb-24 md:pt-16">
      ...
      <div className="flex-1 p-6 md:p-12 flex flex-col justify-center max-w-4xl mx-auto w-full">
        {featureDisabled ? (
          <div className="bg-white rounded-3xl p-12 md:p-16 flex flex-col items-center justify-center text-center space-y-4 border border-gray-100 min-h-[320px] md:min-h-[400px]">
            <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4">
              <Lock size={32} className="text-gray-400" />
            </div>
            <h3 className="text-xl font-bold text-gray-800">创作功能</h3>
