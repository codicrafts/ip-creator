module.exports = [
"[project]/node_modules/.pnpm/bson@4.7.2/node_modules/bson/dist/bson.esm.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
/** @public */ var BSONError = function(_super) {
...
/** @public */ var BSONTypeError = function(_super) {
...
function getGlobal() {
    return checkForMath(typeof globalThis === 'object' && globalThis) || checkForMath(("TURBOPACK compile-time value", "undefined") === 'object' && window) || checkForMath(typeof self === 'object' && self) || checkForMath(("TURBOPACK compile-time value", "object") === 'object' && /*TURBOPACK member replacement*/ __turbopack_context__.g) || // eslint-disable-next-line @typescript-eslint/no-implied-eval
...
var insecureRandomBytes = function insecureRandomBytes(size) {
    ...
    var result = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(size);
...
var detectRandomBytes = function() {
    {
        ...
        try {
            requiredRandomBytes = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)").randomBytes;
        } catch (e) {
        // keep the fallback
        }
 ...
 */ function ensureBuffer(potentialBuffer) {
    if (ArrayBuffer.isView(potentialBuffer)) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(potentialBuffer.buffer, potentialBuffer.byteOffset, potentialBuffer.byteLength);
    }
    if (isAnyArrayBuffer(potentialBuffer)) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(potentialBuffer);
    }
...
var uuidHexStringToBuffer = function(hexString) {
    ...
    return __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(sanitizedHexString, 'hex');
};
...
/** @internal */ var BSON_INT32_MAX$1 = 0x7fffffff;
/** @internal */ var BSON_INT32_MIN$1 = -0x80000000;
/** @internal */ var BSON_INT64_MAX$1 = Math.pow(2, 63) - 1;
/** @internal */ var BSON_INT64_MIN$1 = -Math.pow(2, 63);
/**
...
/** Number BSON Type @internal */ var BSON_DATA_NUMBER = 1;
/** String BSON Type @internal */ var BSON_DATA_STRING = 2;
/** Object BSON Type @internal */ var BSON_DATA_OBJECT = 3;
/** Array BSON Type @internal */ var BSON_DATA_ARRAY = 4;
/** Binary BSON Type @internal */ var BSON_DATA_BINARY = 5;
/** Binary BSON Type @internal */ var BSON_DATA_UNDEFINED = 6;
/** ObjectId BSON Type @internal */ var BSON_DATA_OID = 7;
/** Boolean BSON Type @internal */ var BSON_DATA_BOOLEAN = 8;
/** Date BSON Type @internal */ var BSON_DATA_DATE = 9;
/** null BSON Type @internal */ var BSON_DATA_NULL = 10;
/** RegExp BSON Type @internal */ var BSON_DATA_REGEXP = 11;
/** Code BSON Type @internal */ var BSON_DATA_DBPOINTER = 12;
/** Code BSON Type @internal */ var BSON_DATA_CODE = 13;
/** Symbol BSON Type @internal */ var BSON_DATA_SYMBOL = 14;
/** Code with Scope BSON Type @internal */ var BSON_DATA_CODE_W_SCOPE = 15;
/** 32 bit Integer BSON Type @internal */ var BSON_DATA_INT = 16;
/** Timestamp BSON Type @internal */ var BSON_DATA_TIMESTAMP = 17;
/** Long BSON Type @internal */ var BSON_DATA_LONG = 18;
/** Decimal128 BSON Type @internal */ var BSON_DATA_DECIMAL128 = 19;
/** MinKey BSON Type @internal */ var BSON_DATA_MIN_KEY = 0xff;
/** MaxKey BSON Type @internal */ var BSON_DATA_MAX_KEY = 0x7f;
/** Binary Default Type @internal */ var BSON_BINARY_SUBTYPE_DEFAULT = 0;
/** Binary Function Type @internal */ var BSON_BINARY_SUBTYPE_FUNCTION = 1;
/** Binary Byte Array Type @internal */ var BSON_BINARY_SUBTYPE_BYTE_ARRAY = 2;
/** Binary Deprecated UUID Type @deprecated Please use BSON_BINARY_SUBTYPE_UUID_NEW @internal */ var BSON_BINARY_SUBTYPE_UUID = 3;
/** Binary UUID Type @internal */ var BSON_BINARY_SUBTYPE_UUID_NEW = 4;
/** Binary MD5 Type @internal */ var BSON_BINARY_SUBTYPE_MD5 = 5;
/** Encrypted BSON type @internal */ var BSON_BINARY_SUBTYPE_ENCRYPTED = 6;
/** Column BSON type @internal */ var BSON_BINARY_SUBTYPE_COLUMN = 7;
/** Binary User Defined Type @internal */ var BSON_BINARY_SUBTYPE_USER_DEFINED = 128;
/**
 ...
 */ var Binary = function() {
     ...
     */ function Binary(buffer, subType) {
        ...
        if (buffer == null) {
            ...
            this.buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(Binary.BUFFER_SIZE);
            this.position = 0;
        } else {
            if (typeof buffer === 'string') {
                // string
                this.buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(buffer, 'binary');
            } else if (Array.isArray(buffer)) {
                // number[]
                this.buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(buffer);
            } else {
     ...
     */ Binary.prototype.put = function(byteValue) {
        ...
        if (this.buffer.length > this.position) {
            ...
            var buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(Binary.BUFFER_SIZE + this.buffer.length);
     ...
     */ Binary.prototype.write = function(sequence, offset) {
        ...
        if (this.buffer.length < offset + sequence.length) {
            var buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(this.buffer.length + sequence.length);
            this.buffer.copy(buffer, 0, 0, this.buffer.length);
    ...
    /** @internal */ Binary.fromExtendedJSON = function(doc, options) {
        ...
        if ('$binary' in doc) {
            if (options.legacy && typeof doc.$binary === 'string' && '$type' in doc) {
                ...
                data = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(doc.$binary, 'base64');
            } else {
                if (typeof doc.$binary !== 'string') {
                    type = doc.$binary.subType ? parseInt(doc.$binary.subType, 16) : 0;
                    data = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(doc.$binary.base64, 'base64');
                }
            }
        } else if ('$uuid' in doc) {
            type = 4;
 ...
 */ var UUID = function(_super) {
     ...
     */ function UUID(input) {
        ...
        if (input == null) {
            ...
            bytes = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(input.buffer);
            hexStr = input.__id;
     ...
     */ UUID.generate = function() {
        ...
        return __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(bytes);
    };
    /**
...
/** @internal */ function isDBRefLike(value) {
...
/** A cache of the Long representations of small integer values. */ var INT_CACHE = {};
/** A cache of the Long representations of small unsigned integer values. */ var UINT_CACHE = {};
/**
 ...
 */ var Long = function() {
    ...
    /** Maximum unsigned value. */ Long.MAX_UNSIGNED_VALUE = Long.fromBits(0xffffffff | 0, 0xffffffff | 0, true);
    ...
    /** Maximum signed value. */ Long.MAX_VALUE = Long.fromBits(0xffffffff | 0, 0x7fffffff | 0, false);
    /** Minimum signed value. */ Long.MIN_VALUE = Long.fromBits(0, 0x80000000 | 0, false);
    return Long;
}();
     ...
     */ Decimal128.fromString = function(representation) {
        ...
        if (!isDigit(representation[index]) && representation[index] !== '.') {
            if (representation[index] === 'i' || representation[index] === 'I') {
                return new Decimal128(__TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(isNegative ? INF_NEGATIVE_BUFFER : INF_POSITIVE_BUFFER));
            } else if (representation[index] === 'N') {
                return new Decimal128(__TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(NAN_BUFFER));
            }
        }
        // Read all the digits
        ...
        if (representation[index] === 'e' || representation[index] === 'E') {
            ...
            // No digits read
            if (!match || !match[2]) return new Decimal128(__TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(NAN_BUFFER));
            // Get exponent
        ...
        // Return not a number
        if (representation[index]) return new Decimal128(__TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(NAN_BUFFER));
        // Done reading input
        ...
        var buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(16);
        index = 0;
    ...
    /** Create a string representation of the raw Decimal128 value */ Decimal128.prototype.toString = function() {
        ...
        if (scientific_exponent >= 34 || scientific_exponent <= -7 || exponent > 0) {
            ...
            if (significand_digits > 34) {
                ...
                if (exponent > 0) string.push("E+".concat(exponent));
                else if (exponent < 0) string.push("E".concat(exponent));
                return string.join('');
            }
 ...
 */ var ObjectId = function() {
     ...
     */ function ObjectId(inputId) {
        ...
        if (typeof inputId === 'object' && inputId && 'id' in inputId) {
            ...
            if ('toHexString' in inputId && typeof inputId.toHexString === 'function') {
                workingId = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(inputId.toHexString(), 'hex');
            } else {
        ...
        if (workingId == null || typeof workingId === 'number') {
            ...
            this[kId] = workingId instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"] ? workingId : ensureBuffer(workingId);
        } else if (typeof workingId === 'string') {
            if (workingId.length === 12) {
                var bytes = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(workingId);
                ...
                this[kId] = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(workingId, 'hex');
            } else {
     ...
     */ ObjectId.generate = function(time) {
        ...
        var buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(12);
        // 4-byte timestamp
     ...
     */ ObjectId.prototype.equals = function(otherId) {
        ...
        if (typeof otherId === 'string' && ObjectId.isValid(otherId) && otherId.length === 12 && isUint8Array(this.id)) {
            return otherId === __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].prototype.toString.call(this.id, 'latin1');
        }
        if (typeof otherId === 'string' && ObjectId.isValid(otherId) && otherId.length === 24) {
            return otherId.toLowerCase() === this.toHexString();
        }
        if (typeof otherId === 'string' && ObjectId.isValid(otherId) && otherId.length === 12) {
            return __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(otherId).equals(this.id);
        }
     ...
     */ ObjectId.createFromTime = function(time) {
        var buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from([
            0,
            0,
            0,
            0,
     ...
     */ ObjectId.createFromHexString = function(hexString) {
        ...
        return new ObjectId(__TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].from(hexString, 'hex'));
    };
    /**
    ...
    /** @internal */ ObjectId.index = Math.floor(Math.random() * 0xffffff);
    return ObjectId;
}();
// Deprecated methods
...
/** @public */ var LongWithoutOverridesClass = Long;
/**
 * @public
 * @category BSONType
...
/* eslint-disable @typescript-eslint/no-explicit-any */ /** @public */ var bsonMap;
...
if (bsonGlobal.Map) {
    ...
    bsonMap = function() {
        ...
        Map.prototype.forEach = function(callback, self1) {
            self1 = self1 || this;
            for(var i = 0; i < this._keys.length; i++){
                var key = this._keys[i];
                // Call the forEach callback
                callback.call(self1, this._values[key].v, key, self1);
            }
        };
...
/** @internal */ function calculateElement(name, // eslint-disable-next-line @typescript-eslint/no-explicit-any
value, serializeFunctions, isArray, ignoreUndefined) {
    ...
    switch(typeof value){
        case 'string':
            return 1 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 + 4 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value, 'utf8') + 1;
        case 'number':
            if (Math.floor(value) === value && value >= JS_INT_MIN && value <= JS_INT_MAX) {
                if (value >= BSON_INT32_MIN$1 && value <= BSON_INT32_MAX$1) {
                    // 32 bit
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (4 + 1);
                } else {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (8 + 1);
                }
            } else {
                // 64 bit
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (8 + 1);
        ...
        case 'undefined':
            if (isArray || !ignoreUndefined) return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1;
            return 0;
        case 'boolean':
            return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (1 + 1);
        case 'object':
            if (value == null || value['_bsontype'] === 'MinKey' || value['_bsontype'] === 'MaxKey') {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1;
            } else if (value['_bsontype'] === 'ObjectId' || value['_bsontype'] === 'ObjectID') {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (12 + 1);
            } else if (value instanceof Date || isDate(value)) {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (8 + 1);
            } else if (ArrayBuffer.isView(value) || value instanceof ArrayBuffer || isAnyArrayBuffer(value)) {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (1 + 4 + 1) + value.byteLength;
            } else if (value['_bsontype'] === 'Long' || value['_bsontype'] === 'Double' || value['_bsontype'] === 'Timestamp') {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (8 + 1);
            } else if (value['_bsontype'] === 'Decimal128') {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (16 + 1);
            } else if (value['_bsontype'] === 'Code') {
                // Calculate size depending on the availability of a scope
                if (value.scope != null && Object.keys(value.scope).length > 0) {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + 4 + 4 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value.code.toString(), 'utf8') + 1 + calculateObjectSize$1(value.scope, serializeFunctions, ignoreUndefined);
                } else {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + 4 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value.code.toString(), 'utf8') + 1;
                }
            } else if (value['_bsontype'] === 'Binary') {
                var binary = value;
                // Check what kind of subtype we have
                if (binary.sub_type === Binary.SUBTYPE_BYTE_ARRAY) {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (binary.position + 1 + 4 + 1 + 4);
                } else {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + (binary.position + 1 + 4 + 1);
                }
            } else if (value['_bsontype'] === 'Symbol') {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value.value, 'utf8') + 4 + 1 + 1;
                ...
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + calculateObjectSize$1(ordered_values, serializeFunctions, ignoreUndefined);
            } else if (value instanceof RegExp || isRegExp(value)) {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value.source, 'utf8') + 1 + (value.global ? 1 : 0) + (value.ignoreCase ? 1 : 0) + (value.multiline ? 1 : 0) + 1;
            } else if (value['_bsontype'] === 'BSONRegExp') {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value.pattern, 'utf8') + 1 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(value.options, 'utf8') + 1;
            } else {
                return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + calculateObjectSize$1(value, serializeFunctions, ignoreUndefined) + 1;
            }
        case 'function':
            ...
            if (value instanceof RegExp || isRegExp(value) || String.call(value) === '[object RegExp]') {
                ...
                if (serializeFunctions && value.scope != null && Object.keys(value.scope).length > 0) {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + 4 + 4 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(normalizedFunctionString(value), 'utf8') + 1 + calculateObjectSize$1(value.scope, serializeFunctions, ignoreUndefined);
                } else if (serializeFunctions) {
                    return (name != null ? __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(name, 'utf8') + 1 : 0) + 1 + 4 + __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].byteLength(normalizedFunctionString(value), 'utf8') + 1;
                }
            }
    }
    return 0;
...
function deserializeObject(buffer, index, options, isArray) {
    ...
    while(!done){
        ...
        if (elementType === BSON_DATA_STRING) {
            ...
            var oid = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(12);
            ...
            var bytes = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(16);
            ...
            if (buffer['slice'] != null) {
                ...
                var _buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(binarySize);
                // If we have subtype 2 skip the 4 bytes for the size
                if (subType === Binary.SUBTYPE_BYTE_ARRAY) {
                    binarySize = buffer[index++] | buffer[index++] << 8 | buffer[index++] << 16 | buffer[index++] << 24;
                    if (binarySize < 0) throw new BSONError('Negative binary type element size found for subtype 0x02');
            ...
            index = index + stringSize;
            // Read the oid
            var oidBuffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(12);
...
var buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(MAXSIZE);
/**
 ...
 */ function setInternalBufferSize(size) {
    ...
    if (buffer.length < size) {
        buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(size);
    }
}
/**
 ...
 */ function serialize(object, options) {
    ...
    if (buffer.length < minInternalBufferSize) {
        buffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(minInternalBufferSize);
    }
    // Attempt to serialize
    var serializationIndex = serializeInto(buffer, object, checkKeys, 0, 0, serializeFunctions, ignoreUndefined, []);
    // Create the final buffer
    var finishedBuffer = __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"].alloc(serializationIndex);
 ...
 */ function deserialize(buffer, options) {
    ...
    return deserialize$1(buffer instanceof __TURBOPACK__imported__module__$5b$externals$5d2f$buffer__$5b$external$5d$__$28$buffer$2c$__cjs$29$__["Buffer"] ? buffer : ensureBuffer(buffer), options);
}
/**
...
const __TURBOPACK__default__export__ = BSON;
;
 //# sourceMappingURL=bson.esm.js.map
}),
];

//# sourceMappingURL=1a3d5_bson_dist_bson_esm_b66ba1ed.js.map