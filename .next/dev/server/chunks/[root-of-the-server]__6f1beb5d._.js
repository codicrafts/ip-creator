...
"[project]/app/api/gemini/generate/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const API_BASE_URL = "https://api.laozhang.ai/v1beta/models/gemini-3-pro-image-preview:generateContent";
    ...
    try {
        ...
        if (!response.ok) {
            ...
            try {
                ...
                console.error("Request body (generationConfig):", JSON.stringify(requestBody.generationConfig, null, 2));
            } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6f1beb5d._.js.map