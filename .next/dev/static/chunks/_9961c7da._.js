            ...
            const initUser = {
                "ReduxInitializer.useEffect.initUser": async ()=>{
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isAuthenticated"])()) {
                        ...
                        const savedTier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cookies$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserTier"])() || localStorage.getItem(USER_TIER_KEY);
                        if (userId) {
                            try {
                                // 从后端获取用户信息（包括使用次数）
...
//# sourceMappingURL=_9961c7da._.js.map