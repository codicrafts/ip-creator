...
"[project]/lib/image-storage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/image-storage.ts [app-client] (ecmascript)");
...
function EditPage() {
    ...
    const userStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "EditPage.useAppSelector[userStatus]": (state)=>state.user.status
    }["EditPage.useAppSelector[userStatus]"]);
    const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "EditPage.useAppSelector[userId]": (state)=>state.user.userId
    }["EditPage.useAppSelector[userId]"]);
    ...
    const isQuotaModalOpen = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "EditPage.useAppSelector[isQuotaModalOpen]": (state)=>state.app.isQuotaModalOpen
    }["EditPage.useAppSelector[isQuotaModalOpen]"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditPage.useEffect": ()=>{
            ...
            if (!sourceImage) {
                const savedImage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadSourceImage"])();
                if (savedImage) {
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$imageSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSourceImage"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$3_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditPage.useEffect": ()=>{
            if (sourceImage) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$image$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveSourceImage"])(sourceImage, mimeType);
            }
        }
    }["EditPage.useEffect"], [
        sourceImage,
    ...
    const isQuotaReached = ()=>{
        ...
        const usageDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$date$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["normalizeDateString"])(sceneUsage.date);
    ...
    const handleGenerate = async ()=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$geminiService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateExtendedScene"])(sourceImage, mimeType, finalPrompt, aspectRatio);
            // 场景扩展生成成功，增加使用次数
            ...
            if (userStatus === "LOGGED_IN" && userId) {
                try {
                    const updatedUsage = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$userService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateSceneUsage"])(userId, 1);
                    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$slices$2f$userSlice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setSceneUsage"])(updatedUsage));
                } catch (error) {
                    console.error("Failed to sync scene usage to backend:", error);
                }
            }
            // 保存历史记录到数据库
            const historyItem = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$historyService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveHistory"])("scene", result, prompt, styleLabels);
...
_s(EditPage, "casN95WpmqMoT+U9ClbT6Ngc+YE=", false, function() {
    return [
...
//# sourceMappingURL=_dc94c365._.js.map